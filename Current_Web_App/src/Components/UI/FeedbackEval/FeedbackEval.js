...
function FeedbackEval() {
  ...
  const calculateHistoryScore = () => {
    ...
    console.log(
      ...
      inCorrectCount,
      "len",
      countCorrectHistoryTaking.length
    );
    if (correctCount > inCorrectCount) {
      ...
      TotalScore =
        100 *
        (weightForHis / 10) *
        (correctCount / countCorrectHistoryTaking) *
        0.75;
    ...
    >
      ...
      <div className="fdcard">
        <Card sx={{ maxWidth: 1200, maxHeight: 3000 }}>
          <div>
            <Grid container>
              <Grid Item xs={4}>
                <div className="fdmain">Case Id </div>
              </Grid>
              <Grid Item xs={8}>
          ...
          <div>
            <Grid container>
              <Grid Item xs={4}>
                <div className="fdmain">Case Description: </div>
              </Grid>
              <Grid Item xs={8}>
          ...
          <div>
            <Grid container>
              <Grid Item xs={4}>
                <div className="fdmain">Your Score : </div>
              </Grid>
              <Grid Item xs={8}>
                :{Math.round(newStudentScore)}/100.0
              </Grid>
            </Grid>
          </div>
          <div>
            <Grid container>
              <Grid Item xs={4}>
                <div className="fdmain">Your Systematic thinking Score : </div>
              </Grid>
              <Grid Item xs={8}>
                :{Math.round(newStudentScore - diagScore)}/70.0
              </Grid>
            </Grid>
          </div>
          <div>
            <Grid container>
              <Grid Item xs={4}>
                <div className="fdmain">
                  Score based on expansion of knowledge{" "}
                </div>
              </Grid>
              <Grid Item xs={8}>
                :{Math.round(diagScore)}/30.0
              </Grid>
            </Grid>
          </div>
          <div>
            <Grid container>
              <Grid Item xs={4}>
                <div className="fdmain">Your Spent time : </div>
              </Grid>
              <Grid Item xs={8}>
                :{duration}
              </Grid>
          ...
          <div>
            <Grid container>
              <Grid Item xs={3}>
                <div className="fdmain">Score: </div>
              </Grid>
              <Grid Item xs={9}>
                :{Math.round(histScore)}/40.0
              </Grid>
            </Grid>
          </div>
            ...
            <Table striped bordered hover>
              <tbody>
                <tr>
                  ...
                  <th>
                    Wrong Questions. Can you identify why they are wrong ??
                  </th>
                </tr>
                <tr>
                  <td>
                    {correctHistoryQ
                      ? correctHistoryQ.map((que) => <div>{que}</div>)
                      : null}
                  </td>
                  <td>
                    {wrongHistoryQ
                      ? wrongHistoryQ.map((que) => <div>{que}</div>)
                      : null}
                  </td>
                </tr>
              </tbody>
          ...
          <div>
            <Grid container>
              ...
              <Grid Item xs={9}>
                :{Math.round(newStudentScore - diagScore - histScore)}/30.0
              </Grid>
            </Grid>
          </div>
          <div className="fdtopic2">
            Tools need for Periodontal screening/BPE
          </div>
            ...
            <Table striped bordered hover>
              <tbody>
                ...
                <tr>
                  <td>
                    {perioselectedTool
                      ? perioselectedTool.map((que) => <div>{que}</div>)
                      : null}
                  </td>
                  <td>
                    {perioselectedToolAns
                      ? perioselectedToolAns.map((que) => <div>{que}</div>)
                      : null}
                  </td>
                </tr>
              </tbody>
            ...
            <Table striped bordered hover>
              <tbody>
                ...
                <tr>
                  <td>
                    {hardselectedTool
                      ? hardselectedTool.map((que) => <div>{que}</div>)
                      : null}
                  </td>
                  <td>
                    {hardselectedToolAns
                      ? hardselectedToolAns.map((que) => <div>{que}</div>)
                      : null}
                  </td>
                </tr>
              </tbody>
          ...
          <div className="fdtable1">
            <Table striped bordered hover>
              <tbody>
                ...
                <tr>
                  <td>{plaqueValue}</td>
                  <td>{selectedCaseDetails.Hard_plaque_score}</td>
                </tr>
              </tbody>
            </Table>
          </div>
          ...
          <div className="fdtable1">
            <Table striped bordered hover>
              <tbody>
                ...
                <tr>
                  <td>{bleedingValue}</td>
                  <td>{selectedCaseDetails.Hard_bleeding_score}</td>
                </tr>
              </tbody>
            </Table>
          </div>
          ...
          <div className="fdtable1">
            <Table striped bordered hover>
              <tbody>
                ...
                <tr>
                  <td>{radio ? radio.map((que) => <div>{que}</div>) : null}</td>
                  <td>
                    {radioAns ? radioAns.map((que) => <div>{que}</div>) : null}
                  </td>
                </tr>
              </tbody>
            </Table>
          ...
          <div>
            <Grid container>
              <Grid Item xs={3}>
                <div className="fdmain">Diagnosis score : </div>
              </Grid>
              <Grid Item xs={9}>
                :{Math.round(diagScore)}/30.0
              </Grid>
          ...
          {selectedAnsForDiagnosisQ
            ? selectedAnsForDiagnosisQ.map((que) => (
                <div>
      ...
      <div className="fdsubmit2">
        <button
          ...
          fdprocessedid="6whgsi"
        >
          Exit and back to Home
        </button>
      </div>
    </div>
  );
